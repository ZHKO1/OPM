...
var bysuit = {
    deck: function deck(_deck) {
        ...
        function bysuit(next) {
            var cards = _deck.cards.filter(function (card) {
...
var myReady = {
    deck: function deck(_deck) {
        ...
        function myReady(next) {
            ...
            cards = _deck.cards.filter(function (card) {
                return !card.isStaticNode();
            }).slice(0, 4);
...
function Card (i) {
    ...
    // self = card
    var self = { i: i, rank: rank, suit: suit, id: id, pos: i, $el: $el, mount: mount, unmount: unmount, setSide: setSide };
...
function Deck() {
    ...
    var $el = createElement('div');
    var self = observable({ mount: mount, unmount: unmount, cleanDragCard: cleanDragCard, cards: cards, $el: $el });
    var $root;
